...
//Command     : generate_target design_FND_Controller_wrapper.bd
//Design      : design_FND_Controller_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module design_FND_Controller_wrapper
   (button_tri_io,
    led_tri_io,
    o_digit,
    o_font,
  ...
  IOBUF button_tri_iobuf_3
       (.I(button_tri_o_3),
        ...
        .O(button_tri_i_3),
        .T(button_tri_t_3));
  design_FND_Controller design_FND_Controller_i
       (.button_tri_i({button_tri_i_3,button_tri_i_2,button_tri_i_1,button_tri_i_0}),
        ...
        .o_font(o_font),
        .reset(reset),
        .switch_tri_i({switch_tri_i_3,switch_tri_i_2,switch_tri_i_1,switch_tri_i_0}),
        .switch_tri_o({switch_tri_o_3,switch_tri_o_2,switch_tri_o_1,switch_tri_o_0}),
        .switch_tri_t({switch_tri_t_3,switch_tri_t_2,switch_tri_t_1,switch_tri_t_0}),
        .sys_clock(sys_clock),
